...
public class Appl {
	...
	public static void main(String[] args) {
		...
		System.out.println("monthDays.length = " + monthDays);
		System.out.println("monthDays = " + Arrays.toString(monthDays));
		System.out.println("Arrays.equals(monthDays, monthDays3) = " + Arrays.equals(monthDays, monthDays3));
		//
		//
		System.out.println("\n-1. for (int i=0; ...)");
		...
		*/
        ...
        System.out.println("\n7. for ( ; ; )");
        for ( ; ; ) {
            if (m1 >= monthDays.length) {
                break;
            }
            System.out.print(monthDays[m1] + "  ");
            m1++;
        }
		*/
		// /*-
