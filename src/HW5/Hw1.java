...
public class Hw1 {
	...
	public static void main(String[] args) {
		...
		if (a >= -5 && a <= 5 && b >= -5 && b <= 5 && c >= -5 && c <= 5) {
			...
			System.out.println("No, numbers don't belong to range");
		System.out.println();
		...
		case 404:
			...
			break;
		case 406:
			System.out.println(Error.NotAcceptable);
			break;
		case 500:
			System.out.println(Error.InternalServerError);
			break;
		case 502:
			System.out.println(Error.BadGateway);
			break;
		default:
			System.out.println("Sorry, I don't know this code");
		}
	}
